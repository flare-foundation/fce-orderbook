...
- one-shot bindings (`setTeeAddress` / `setTeeAuthority`) must be written **last**
...
[types-server.md](types-server.md)

## Extension-specific

Whatever this extension actually does. Here:

[flows/](flows/) — deposit, orders, withdrawal walkthroughs ·
[state-backup-staging.md](state-backup-staging.md) — encrypted state backup runbook ·
[stress-test.md](stress-test.md) — load-testing harness
